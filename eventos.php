...
<div class="col-lg-4 col-md-6 col-sm-12 mb-4">
    <div class="card h-100 d-flex flex-column" style="background-image: url('img/f0f4973ad8adca268f9b9feb95d1a980.jpg'); background-size: cover; background-position: center;">
        ...
        <div class="card-body flex-grow-1" style="background: transparent;">
            ...
            <button class="btn btn-link mt-3 btn-responsive" data-bs-toggle="collapse" data-bs-target="#texto-expoOtaku" aria-expanded="false" aria-controls="texto-expoOtaku" style="color: white; text-shadow: -2px -2px 0 #000, 2px -2px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000; font-family: 'Luckiest Guy', cursive; font-weight: 400; font-style: normal;">
        ...
        <div class="mt-auto p-3 d-flex justify-content-center" style="background-image: url('img/anaranjado.jpg'); ">
            <a href="https://www.instagram.com/expo.otaku/" class="btn btn-sm btn-primary btn-responsive" style="font-family: 'Bungee Inline', sans-serif;">
                Redes sociales😊
            </a>
        </div>
    </div>
 ...
 <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
    <div class="card h-100 d-flex flex-column" style="background-image: url('img/f0f4973ad8adca268f9b9feb95d1a980.jpg'); background-size: cover; background-position: center;">
        ...
        <div class="card-body flex-grow-1" style="background: transparent;">
            ...
            <!-- Agregar el botón para desplegar el párrafo -->
            <button class="btn btn-link mt-3 btn-responsive" data-bs-toggle="collapse" data-bs-target="#texto-animefest" aria-expanded="false" aria-controls="texto-animefest" style="color: white; text-shadow: -2px -2px 0 #000, 2px -2px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000; font-family: 'Luckiest Guy', cursive; font-weight: 400; font-style: normal;">
                Acerca de Nuestro Evento
            </button>
            <!-- Contenido del párrafo, inicialmente oculto -->
        ...
        <div class="mt-auto p-3 d-flex justify-content-center" style="background-image: url('img/anaranjado.jpg'); ">
            <a href="https://www.instagram.com/animefestcts/" class="btn btn-sm btn-primary btn-responsive" style="font-family: 'Bungee Inline', sans-serif;">
                Redes sociales😊
            </a>
        </div>
    </div>
 ...
 <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
    <div class="card h-100 d-flex flex-column" style="background-image: url('img/f0f4973ad8adca268f9b9feb95d1a980.jpg'); background-size: cover; background-position: center;">
        ...
        <div class="card-body flex-grow-1" style="background: transparent;">
            ...
            <!-- Agregar el botón para desplegar el párrafo -->
            <button class="btn btn-link mt-3 btn-responsive" data-bs-toggle="collapse" data-bs-target="#texto-geekfest" aria-expanded="false" aria-controls="texto-geekfest" style="color: white; text-shadow: -2px -2px 0 #000, 2px -2px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000; font-family: 'Luckiest Guy', cursive; font-weight: 400; font-style: normal;">
                Acerca de Nuestro Evento
            </button>
            <!-- Contenido del párrafo, inicialmente oculto -->
        ...
        <div class="mt-auto p-3 d-flex justify-content-center" style="background-image: url('img/anaranjado.jpg'); ">
            <a href="https://www.instagram.com/geekfestctes/" class="btn btn-sm btn-primary btn-responsive" style="font-family: 'Bungee Inline', sans-serif;">
                Redes sociales😊
            </a>
        </div>
    </div>
...
<div class="col-lg-4 col-md-6 col-sm-12 mb-4">
    <div class="card h-100 d-flex flex-column" style="background-image: url('img/f0f4973ad8adca268f9b9feb95d1a980.jpg'); background-size: cover; background-position: center;">
        ...
        <div class="card-body flex-grow-1" style="background: transparent;">
            ...
            <!-- Agregar el botón para desplegar el párrafo -->
            <button class="btn btn-link mt-3 btn-responsive" data-bs-toggle="collapse" data-bs-target="#texto-cbk" aria-expanded="false" aria-controls="texto-cbk" style="color: white; text-shadow: -2px -2px 0 #000, 2px -2px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000; font-family: 'Luckiest Guy', cursive; font-weight: 400; font-style: normal;">
                Acerca de Nuestro Evento
            </button>
            <!-- Contenido del párrafo, inicialmente oculto -->
        ...
        <div class="mt-auto p-3 d-flex justify-content-center" style="background-image: url('img/anaranjado.jpg'); ">
            <a href="https://www.instagram.com/cbkpop_/" class="btn btn-sm btn-primary btn-responsive" style="font-family: 'Bungee Inline', sans-serif;">
                Redes sociales😊
            </a>
        </div>
    </div>
...
<div class="col-lg-4 col-md-6 col-sm-12 mb-4">
    <div class="card h-100 d-flex flex-column" style="background-image: url('img/f0f4973ad8adca268f9b9feb95d1a980.jpg'); background-size: cover; background-position: center;">
        ...
        <div class="card-body flex-grow-1" style="background: transparent;">
            ...
            <!-- Agregar el botón para desplegar el párrafo -->
            <button class="btn btn-link mt-3 btn-responsive" data-bs-toggle="collapse" data-bs-target="#texto-oneforfest" aria-expanded="false" aria-controls="texto-oneforfest" style="color: white; text-shadow: -2px -2px 0 #000, 2px -2px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000; font-family: 'Luckiest Guy', cursive; font-weight: 400; font-style: normal;">
                Acerca de Nuestro Evento
            </button>
            <!-- Contenido del párrafo, inicialmente oculto -->
        ...
        <div class="mt-auto p-3 d-flex justify-content-center" style="background-image: url('img/anaranjado.jpg'); ">
            <a href="https://www.instagram.com/one.for.fest/" class="btn btn-sm btn-primary btn-responsive" style="font-family: 'Bungee Inline', sans-serif;">
                Redes sociales😊
            </a>
        </div>
    </div>
...
<div class="col-lg-4 col-md-6 col-sm-12 mb-4">
    <div class="card h-100 d-flex flex-column" style="background-image: url('img/f0f4973ad8adca268f9b9feb95d1a980.jpg'); background-size: cover; background-position: center;">
        ...
        <div class="card-body flex-grow-1" style="background: transparent;">
            ...
            <!-- Agregar el botón para desplegar el párrafo -->
            <button class="btn btn-link mt-3 btn-responsive" data-bs-toggle="collapse" data-bs-target="#texto-mangfest" aria-expanded="false" aria-controls="texto-mangfest" style="color: white; text-shadow: -2px -2px 0 #000, 2px -2px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000; font-family: 'Luckiest Guy', cursive; font-weight: 400; font-style: normal;">
                Acerca de Nuestro Evento
            </button>
            <!-- Contenido del párrafo, inicialmente oculto -->
        ...
        <div class="mt-auto p-3 d-flex justify-content-center" style="background-image: url('img/anaranjado.jpg'); ">
            <a href="https://www.instagram.com/mang.fest/" class="btn btn-sm btn-primary btn-responsive" style="font-family: 'Bungee Inline', sans-serif;">
                Redes sociales😊
            </a>
        </div>
    </div>
...
<div class="col-lg-4 col-md-6 col-sm-12 mb-4">
    <div class="card h-100 d-flex flex-column" style="background-image: url('img/f0f4973ad8adca268f9b9feb95d1a980.jpg'); background-size: cover; background-position: center;">
        <h4 class="card-header text-center responsive-text" style="background-image: url('img/anaranjado.jpg'); font-family: 'Luckiest Guy', cursive; font-weight: 400; font-style: normal; margin-top: 0px; margin-left: 0px; color: #FF0000; text-shadow: -3px -3px 0 #000,1px -1px 0 #000,-5px  5px 0 #000,1px  1px 0 #000;">Hinoishi</h4>
        <div class="card-body flex-grow-1" style="background: transparent;">
            <img src="img/HINOISHI.jpg" class="img-fluid rounded mx-auto d-block" alt="Responsive image">
            <!-- Agregar el botón para desplegar el párrafo -->
            <button class="btn btn-link mt-3 btn-responsive" data-bs-toggle="collapse" data-bs-target="#texto-hinoishi" aria-expanded="false" aria-controls="texto-hinoishi" style="color: white; text-shadow: -2px -2px 0 #000, 2px -2px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000; font-family: 'Luckiest Guy', cursive; font-weight: 400; font-style: normal;">
                Acerca de Nuestro Evento
            </button>
            <!-- Contenido del párrafo, inicialmente oculto -->
            <div class="collapse" id="texto-hinoishi">
                <p class="card-text text-responsive" style="font-family: Bangers, system-ui; font-weight: 400; font-style: normal; text-align: justify; color: #000000; letter-spacing: -0.0px;">
        ...
        <div class="mt-auto p-3 d-flex justify-content-center" style="background-image: url('img/anaranjado.jpg'); ">
            <a href="https://www.instagram.com/hinoishictes/" class="btn btn-sm btn-primary btn-responsive" style="font-family: 'Bungee Inline', sans-serif;">
                Redes sociales😊
            </a>
        </div>
    </div>
...
<div class="col-lg-4 col-md-6 col-sm-12 mb-4">
    <div class="card h-100 d-flex flex-column" style="background-image: url('img/f0f4973ad8adca268f9b9feb95d1a980.jpg'); background-size: cover; background-position: center;">
        ...
        <div class="card-body flex-grow-1" style="background: transparent;">
            <img src="img/ASIANEXPO.jpg" class="img-fluid rounded mx-auto d-block" alt="Responsive image">
            <!-- Agregar el botón para desplegar el párrafo -->
            <button class="btn btn-link mt-3 btn-responsive" data-bs-toggle="collapse" data-bs-target="#texto-asianexpo" aria-expanded="false" aria-controls="texto-asianexpo" style="color: white; text-shadow: -2px -2px 0 #000, 2px -2px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000; font-family: 'Luckiest Guy', cursive; font-weight: 400; font-style: normal;">
                Acerca de Nuestro Evento
            </button>
            <!-- Contenido del párrafo, inicialmente oculto -->
        ...
        <div class="mt-auto p-3 d-flex justify-content-center" style="background-image: url('img/anaranjado.jpg'); ">
            <a href="https://www.instagram.com/asian_expo_/" class="btn btn-sm btn-primary btn-responsive" style="font-family: 'Bungee Inline', sans-serif;">
                Redes sociales😊
            </a>
        </div>
    </div>
