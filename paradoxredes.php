...
<div class="row justify-content-center">
    <!-- Botón de WhatsApp -->
    <div class="col-auto">
        <a href="https://chat.whatsapp.com/Exz7M4dS4rs2QM9Y14zYl6" target="_blank">
    ...
    <!-- Botón de Facebook -->
    <div class="col-auto">
        <a href="https://www.facebook.com/nombre_de_usuario/" target="_blank">
            <img src="img/facebook.png" alt="Facebook" style="background-color: orange; margin-top: -34px; width: 60px; height: 60px; background-size: cover; background-position: center; padding: 10px; border-radius: 20%;">
        </a>
    </div>
</div>
